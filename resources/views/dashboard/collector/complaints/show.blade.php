...
@section('Content')
    ...
    <div class="max-w-6xl mx-auto bg-white shadow-lg rounded-2xl p-6 border border-gray-100">
        <!-- Header -->
        <div class="flex justify-between items-center mb-6">
            <h2 class="f-12 font-bold text-[#1B7A75]">
                تفاصيل الطلب رقم #{{ $complaint->serial_number }}
            </h2>
            <button onclick="openPhoneModal()"
                class="bg-[#1B7A75] hover:bg-[#16615C] text-white px-5 py-2.5 rounded-lg f-12 font-medium shadow-md transition duration-200">
                تعديل أرقام الجوال
            </button>
        </div>
