                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="service_requested" name="service_requested"
                                ...
                                <option value="تحصيل قبل المحكمة 8%">تحصيل قبل المحكمة 8%</option>
                                <option value="بعد التنفيذ 10%">بعد التنفيذ 10%</option>
                                <option value="1إجراء قضائي أعلى من 500 الف 15%">1إجراء قضائي أعلى من 500 الف 15%</option>
                                <option value="إجراء قضائي اقل من 500 الف 20% ">إجراء قضائي اقل من 500 الف 20% </option>
                                <option value="تحصيل الديون المتعثرة 25%">تحصيل الديون المتعثرة 25%</option>
                            </select>
                        </div>
                    </div>
                </div>
