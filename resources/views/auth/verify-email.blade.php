            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-strong p-6">
                    ...
                    <div class="mb-4 text-sm text-gray-600">
                        شكرًا لتسجيلك! قبل البدء، هل يمكنك التحقق من بريدك الإلكتروني بالضغط على الرابط الذي أرسلناه إليك
                        <br>
                        إذا لم تجد الرسالة في صندوق الوارد، الرجاء التحقق من مجلد <strong>Spam</strong> أو
                        <strong>Junk</strong>.
                    </div>
